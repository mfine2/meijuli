...
MongoClient.connect("mongodb://localhost:27017/meijuli", {native_parser: true}, function(err, db) {
	...
	for(var i = 1; i <= COUNT; i++) {
		...
		obj.mp4 = "mp4/Friends.Season03/friends.s03e" + fixedI + ".720p.bluray.x264-psychd.mp4";
		obj.srt = "srt/Friends.Season03/friends.s03e" + fixedI + ".720p.bluRay.x264-psychd.eng&chs.json";
		(function(i) {
